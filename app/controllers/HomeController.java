...
public class HomeController extends Controller {
    ...
    /**
     * return list of companies for location.
     *
     * @param id Id of location
     */
    public CompletionStage<Result> listById(Http.Request request, Long id, boolean locName) {
        if (locName) {
            return companyRepository.companiesByLocationFn(id)
                    .thenApply(Json::toJson)
                    .thenApplyAsync(Results::ok, httpExecutionContext.current());
        } else {
            return companyRepository.companiesByLocation(id)
                    .thenApply(Json::toJson)
                    .thenApplyAsync(Results::ok, httpExecutionContext.current());
        }
    }
